...
for file in ../output/data_trimmed/*R1_001.fastq.gz; do 
	...
	~/bowtie2-2.3.4.1-macos-x86_64/bowtie2 -p 4 --very-sensitive-local -x ./bt2_index -q -U ../output/data_trimmed/$individualF".fastq.gz" | samtools view -bSF4 - > ../output/data_aligned/$individual".bam"
	# Write to fastq
